                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header modal-bg">
                                            ...
                                            <h4 class="modal-title text-white">Delete <span class="text-capitalize">{{$course_allocation->course->title}} </span> Course Allocation </h4>
                                             <h3 class="font-bold"></h3>
                                        </div>
                                        <form action="{{ route('departmentalOfficercourse-allocations.destroy',['course_allocation'=>$course_allocation])}}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                        ...
                                        <h5 class="text-danger text-center"> Note! Once Deleted, It can not be Retrived</h5>
                                             ...
                                             <input type="hidden" value="{{$course_allocation->id}}" name="id">
