                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header modal-bg">
                                            ...
                                            <h4 class="modal-title text-white">Delete <span class="text-capitalize">{{$department->title}}</span> Department </h4>
                                             <h3 class="font-bold"></h3>
                                        </div>
                                        <form action="{{ route('admindepartments.destroy',['department'=>$department])}}" method="POST">
                                                @csrf
                                                @method('DELETE')
