                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header modal-bg">
                                            ...
                                            <h4 class="modal-title text-white">Delete <span class="text-capitalize">{{$semester->title}}</span> Semester</h4>
                                             <h3 class="font-bold"></h3>
                                        </div>
                                        <form action="{{ route('adminsemesters.destroy',['semester'=>$semester])}}" method="POST">
                                                @csrf
                                                @method('DELETE')
