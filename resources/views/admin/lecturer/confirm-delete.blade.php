                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header modal-bg">
                                            ...
                                            <h4 class="modal-title text-white">Delete  Lecturer <span class="text-capitalize">{{$lecturer->fullname}}</span> </h4>
                                             <h3 class="font-bold"></h3>
                                        </div>
                                        <form action="{{ route('adminlecturers.destroy',['lecturer'=>$lecturer])}}" method="POST">
                                                @csrf
                                                @method('DELETE')
